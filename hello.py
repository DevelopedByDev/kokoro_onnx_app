...
text = """Neural networks are powerful machine learning models inspired by the human brain. They consist of layers of interconnected nodes, or neurons, that process data by passing signals forward and adjusting weights through training. These models can learn complex patterns in data, making them ideal for tasks like image recognition, natural language processing, and speech generation. In text-to-speech systems, neural networks transform written text into natural-sounding speech by modeling the relationship between linguistic features and audio waveforms. Recent advancements, such as deep and recurrent networks, have significantly improved the quality, clarity, and human-likeness of synthetic speech generated by these systems."""
